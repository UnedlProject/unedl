...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <form action="{{route('create.crecimiento')}}" role="form" method="post">
                    {{csrf_field()}}
                    @include('includes.messages-block')
                    <h2>Crecimientos</h2>
                    <div class="form-group {{ $errors->has('objetivo') ? ' has-error' : '' }}">
                        <label for="">Objetivo</label>
                        <input id="objetivo" type="text" class="form-control" name="objetivo" placeholder="indica el objetivo">
                    ...
                    <div class="form-group {{ $errors->has('nombre_indicador') ? ' has-error' : '' }}">
                        ...
                        <select name="nombre_indicador" id="nombre_indicador" class="form-control">
                            ...
                            @foreach($indicador as $indicadores)
                                <option value="{{$indicadores->nombre}}">{{$indicadores->nombre}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group {{ $errors->has('descripcion_indicador') ? ' has-error' : '' }}">
                        ...
                        <textarea type="text" class="form-control" name="descripcion_indicador" placeholder="descripcion del indicador" rows="4"></textarea>
                    ...
                    <div class="form-group {{ $errors->has('valor_actual') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="valor_actual" name="valor_actual" placeholder="valor actual">
                    ...
                    <div class="form-group {{ $errors->has('meta_cortop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="meta_cortop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{ $errors->has('meta_medianop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="meta_medianop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{ $errors->has('meta_largop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="meta_largop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{$errors->has('proceso_medir') ? 'has-error':''}}">
                        ...
                        <input type="text" class="form-control" name="proceso_medir" placeholder="indica el proceso a medir">
                    ...
                    <div class="form-group {{$errors->has('fuente_datos') ? 'has-error':''}}">
                        ...
                        <input type="text" class="form-control" name="fuente_datos" placeholder="indica la fuente de datos">
                    ...
                    <div class="form-group {{$errors->has('R_calculo') ? 'has-error':''}}">
                        ...
                        <select name="R_calculo" id="R_calculo" class="form-control">
                            ...
                            @foreach($puesto as $puestos)
                                <option value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                            @endforeach
                        </select>
