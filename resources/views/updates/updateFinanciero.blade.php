...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <form action="{{route('update.financiero',['id'=>$financiero->id])}}" role="form" method="post">
                    {{csrf_field()}}
                    @include('includes.messages-block')
                    <h2>Edita Financieros</h2>
                    <div class="form-group {{ $errors->has('objetivo') ? ' has-error' : '' }}">
                        <label for="">Objetivo</label>
                        <input id="objetivo" value="{{$financiero->objetivo}}" type="text" class="form-control" name="objetivo" placeholder="indica el objetivo">
                    ...
                    <div class="form-group {{ $errors->has('nombre_indicador') ? ' has-error' : '' }}">
                        ...
                        <select name="nombre_indicador" id="nombre_indicador" class="form-control">
                            ...
                            @foreach($indicador as $indicadores)
                                <option
                                        {{$financiero->nombre_indicador == $indicadores->nombre ? 'selected':''}}
                    ...
                    <div class="form-group {{ $errors->has('descripcion_indicador') ? ' has-error' : '' }}">
                        ...
                        <textarea type="text" class="form-control" name="descripcion_indicador" placeholder="descripcion del indicador" rows="4">{{$financiero->descripcion_indicador}}</textarea>
                    ...
                    <div class="form-group {{ $errors->has('valor_actual') ? ' has-error' : '' }}">
                        ...
                        <input type="text" value="{{$financiero->valor_actual}}" class="form-control" id="valor_actual" name="valor_actual" placeholder="valor actual">
                    ...
                    <div class="form-group {{ $errors->has('meta_cortop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" value="{{$financiero->meta_cortop}}" class="form-control" name="meta_cortop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{ $errors->has('meta_medianop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" value="{{$financiero->meta_medianop}}" class="form-control" name="meta_medianop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{ $errors->has('meta_largop') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" value="{{$financiero->meta_largop}}" name="meta_largop" placeholder="indica la meta a corto plazo">
                    ...
                    <div class="form-group {{$errors->has('proceso_medir') ? 'has-error':''}}">
                        ...
                        <input type="text" value="{{$financiero->proceso_medir}}" class="form-control" name="proceso_medir" placeholder="indica el proceso a medir">
                    ...
                    <div class="form-group {{$errors->has('frecuencia') ? 'has-error':''}}" >
                        ...
                        <select class="form-control" id="frecuencia" name="frecuencia">
                            <option value="">Selecciona la opcion</option>
                            <option
                                    {{ $financiero->frecuencia =='Mensual' ? 'selected': ''  }}
                                    value="Mensual">Mensual</option>
                            <option
                                    {{ $financiero->frecuencia =='Bimestral' ? 'selected': ''  }}
                                    value="Bimestral">Bimestral</option>
                            <option
                                    {{ $financiero->frecuencia == 'Semestral '? 'selected': ''  }}
                                    value="Semestre">Semestral</option>
                            <option
                                    {{ $financiero->frecuencia =='Anual' ? 'selected': ''  }}
                    ...
                    <div class="form-group {{$errors->has('fuente_datos') ? 'has-error':''}}">
                        ...
                        <input type="text" class="form-control" value="{{$financiero->fuente_datos}}" name="fuente_datos" placeholder="indica la fuente de datos">
                    ...
                    <div class="form-group {{$errors->has('R_calculo') ? 'has-error':''}}">
                        ...
                        <select name="R_calculo" id="R_calculo" class="form-control">
                            ...
                            @foreach($puesto as $puestos)
                                <option
                                        {{$financiero->R_calculo == $puestos->nombre ? 'selected' : ''  }}
                    ...
                    <div class="campos">
                        <div class="form-group">
                            ...
                            <select name="R_calculo1" id="R_calculo1" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_calculo1 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="R_calculo2" id="R_calculo2" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_calculo2 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="R_calculo3" id="R_calculo3" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_calculo3 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group {{$errors->has('R_analisis') ? 'has-error':''}}">
                        ...
                        <select name="R_analisis" id="R_analisis" class="form-control">
                            ...
                            @foreach($puesto as $puestos)
                                <option
                                        {{$financiero->R_analisis == $puestos->nombre ? 'selected' : ''  }}
                                        value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="campos1">
                        <div class="form-group {{$errors->has('R_analisis1') ? 'has-error':''}}">
                            ...
                            <select name="R_analisis1" id="R_analisis1" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_analisis1 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{$errors->has('R_analisis2') ? 'has-error':''}}">
                            ...
                            <select name="R_analisis2" id="R_analisis2" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_analisis2 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{$errors->has('R_analisis3') ? 'has-error':''}}">
                            ...
                            <select name="R_analisis3" id="R_analisis3" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_analisis3 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{$errors->has('R_acciones') ? 'has-error':''}}">
                        ...
                        <select name="R_acciones" id="R_acciones" class="form-control">
                            ...
                            @foreach($puesto as $puestos)
                                <option
                                        {{$financiero->R_acciones == $puestos->nombre ? 'selected' : ''  }}
                                        value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="campos2">
                        <div class="form-group {{$errors->has('R_acciones1') ? 'has-error':''}}">
                            ...
                            <select name="R_acciones1" id="R_acciones1" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_acciones1 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{$errors->has('R_acciones2') ? 'has-error':''}}">
                            ...
                            <select name="R_acciones2" id="R_acciones2" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_acciones2 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{$errors->has('R_acciones3') ? 'has-error':''}}">
                            ...
                            <select name="R_acciones3" id="R_acciones3" class="form-control">
                                ...
                                @foreach($puesto as $puestos)
                                    <option
                                            {{$financiero->R_acciones3 == $puestos->nombre ? 'selected' : ''  }}
                                            value="{{$puestos->nombre}}">{{$puestos->nombre}}</option>
                                @endforeach
                            </select>
